...
export default function Reserve() {
  ...
  return <div className="page-canvas"><PageHero eyebrow="Book your table" title="A great meal starts right here." text="Choose your date, time and table. Live availability means what you see is what you can reserve." />
